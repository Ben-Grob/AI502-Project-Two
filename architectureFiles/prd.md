...
The GVSU Men's Club Soccer team is a self-funded program. Each year, the fundraising chair must manually identify local businesses, find contact information, and write personalized sponsorship emails — a process that takes 10+ hours and relies entirely on personal memory and network. With 30–100 targets needed per cycle, this is a memory-at-scale failure: the right sponsors exist in the community but go unmissed because finding them is too slow and too manual.
